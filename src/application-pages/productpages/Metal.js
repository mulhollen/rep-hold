...
import {Link} from "react-router-dom"
  ...
  const Container = Styled.div`
    ...
    .crispy-acrylic {
      ...
      .pic {
        background-image: url(http://d3oqjm9mexg0ob.cloudfront.net/waluv/site%20assets/metal-print-friends@2x.png);
        background-size: 100%;
        background-repeat: no-repeat;
        margin-right: 84px;
        width: 346px;
...
const Metal = ()=>{
  ...
  return(
    ...
    <div className="background-crispy">
      <div className="crispy-acrylic">why metal prints</div>
      <div className="wrapper">
        <div className="pic">
        </div>
        <div className="acrylic-prints">
          <div className="Acrylic-Prints">Metal Prints</div>
          <div className="reviews"></div>
          <div className="Acrylic-prints-are-f">Metal prints are for those of you who like art a bit softer, more muted, and chic. Aluminum peeks out from behind your image sharpening the details in the art, creating a crisp look.</div>
          <Link to="/Uploader" className="get-started-button-mount">Get Started</Link>
        </div>
      </div>
      </div>
      <div className="background-product">
        <div className="product-details">about metal</div>
        <div className="About-our-Acrylic-Pr">Custom metal prints for your wall</div>
        <div className="para"><p>We've got options - white metal prints for a semi-glossy and vibrant look or brush metal prints for a crisp, matte feel that evokes all the details.</p>
          <ul>
            <li>2 sheets of rust-proof aluminum, over a solid plastic core</li>
            <li>3mm thick, with drilled holes available for mounting</li>
            <li>Sharp, fade-resistant printing - for indoor or outdoor use</li>
            <li>Brushed aluminum gives empty spaces a metallic look</li>
            <li>Coated aluminum provides a white, semi-matte background </li>
          </ul>
        </div>
        <Link to="/Uploader" className="get-started-button-mount">Get Started</Link>
      </div>
      ...
      <div className="metalprintspricingbackground">
        ...
        {width > 767
          ?
          <>
          <div className="metal-prints-pricing">metal prints pricing & sizes</div>
          <div className="chart">
      ...
      <div className="background-mount">
        ...
        <div className="Displaying-your-Meta">Displaying your Metal Prints</div>
